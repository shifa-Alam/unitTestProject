...
import { RelationService } from 'src/app/services/common/relation.service';
import { Relation } from 'src/app/models/common/relation';
...
export class RelationComponent implements OnInit,OnChanges {
  ...
  constructor(private _fb: FormBuilder, private _service: RelationService) { }
