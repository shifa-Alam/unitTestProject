import { MasterAccountType } from '../../models/common/masterAccountType';
import { Component, OnInit, Input, Output, EventEmitter, SimpleChange, OnChanges } from '@angular/core';
import { FormGroup, FormBuilder, Validators } from '@angular/forms';
import { MasterAccountTypeService } from 'src/app/services/common/masterAccountType.service';


@Component({
  selector: 'app-master-account-type',
  templateUrl: './master-account-type.component.html',
  styleUrls: ['./master-account-type.component.scss']
})
export class MasterAccountTypeComponent implements OnInit,OnChanges {

  
  errorMessage: string = "required";
  sharedForm: FormGroup;

  entities: MasterAccountType[] = [];
  @Input('value') value: number;
  @Input('required') required: boolean;
  @Input('disabled') disabled: boolean;
  @Output() notify = new EventEmitter();
  constructor(private _fb: FormBuilder, private _service: MasterAccountTypeService) { }
