...
import { PostingLevel } from 'src/app/models/common/postingLevel';
import { PostingLevelService } from 'src/app/services/common/postingLevel.service';
import { FormGroup, FormBuilder, Validators } from '@angular/forms';

@Component({
  selector: 'app-posting-level',
  templateUrl: './posting-level.component.html',
  styleUrls: ['./posting-level.component.scss']
})
export class PostingLevelComponent implements OnInit {
  ...
  constructor(private _fb: FormBuilder, private _service: PostingLevelService) { }
