...
import { EmploymentTypeService } from 'src/app/services/common/employmentType.service';
import { EmploymentType } from 'src/app/models/common/employmentType';
...
export class EmploymentTypeComponent implements OnInit ,OnChanges{
  errorMessage: string = "required";
  sharedForm: FormGroup;

  entities: EmploymentType[] = [];
  @Input('value') value: number;
  @Input('required') required: boolean;
  @Input('disabled') disabled: boolean;
  @Output() notify = new EventEmitter();
  constructor(private _fb: FormBuilder, private _service: EmploymentTypeService) { }
