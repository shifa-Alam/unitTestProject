import { SubsPlan } from './../../models/users/subsPlan';
import { Component, OnInit, Input, Output, EventEmitter, SimpleChange, OnChanges } from '@angular/core';
import { FormGroup, FormBuilder, Validators } from '@angular/forms';
import { SubsPlanService } from 'src/app/services/common/subsPlan.service';
...
export class SubsPlanComponent implements OnInit,OnChanges {
  ...
  constructor(private _fb: FormBuilder, private _service: SubsPlanService) { }
