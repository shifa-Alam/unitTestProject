...
import { SheetType } from 'src/app/models/common/sheetType';
import { SheetTypeService } from 'src/app/services/common/sheetType.service';

@Component({
  selector: 'app-sheet-type',
  templateUrl: './sheet-type.component.html',
  styleUrls: ['./sheet-type.component.css']
})
export class SheetTypeComponent implements OnInit,OnChanges {
  ...
  constructor(private _fb: FormBuilder, private _service: SheetTypeService) { }
