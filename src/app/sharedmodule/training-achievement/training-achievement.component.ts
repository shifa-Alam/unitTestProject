import { TrainingAchievementService } from './../../services/common/trainingAchievement.service';
import { Component, OnInit, Input, Output, EventEmitter, SimpleChange, OnChanges } from '@angular/core';
import { FormGroup, FormBuilder, Validators } from '@angular/forms';
import { TrainingAchievement } from 'src/app/models/common/trainingAchievement';

@Component({
  selector: 'app-training-achievement',
  templateUrl: './training-achievement.component.html',
  styleUrls: ['./training-achievement.component.scss']
})
export class TrainingAchievementComponent implements OnInit,OnChanges {
  ...
  entities: TrainingAchievement[] = [];
  @Input('value') value: number;
  @Input('required') required: boolean;
  @Input('disabled') disabled: boolean;
  @Output() notify = new EventEmitter();
  constructor(private _fb: FormBuilder, private _service: TrainingAchievementService) { }
