import { PromotionType } from 'src/app/models/common/promotionType';
import { Component, OnInit, Input, Output, EventEmitter, OnChanges, SimpleChange } from '@angular/core';
import { FormGroup, FormBuilder, Validators } from '@angular/forms';
import { PromotionTypeService } from 'src/app/services/common/promotionType.service';
...
export class PromotionTypeComponent implements OnInit ,OnChanges{
  ...
  constructor(private _fb: FormBuilder, private _service: PromotionTypeService) { }
