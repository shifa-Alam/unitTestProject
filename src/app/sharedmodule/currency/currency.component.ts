...
import { Currency } from 'src/app/models/common/currency';
import { CurrencyService } from 'src/app/services/common/currency.service';
...
export class CurrencyComponent implements OnInit,OnChanges {
  ...
  constructor(private _fb: FormBuilder, private _service: CurrencyService) { }
