import { PostingType } from '../../models/common/postingType';
import { Component, OnInit, Input, Output, EventEmitter, SimpleChange, OnChanges } from '@angular/core';
import { FormGroup, FormBuilder, Validators } from '@angular/forms';
import { PostingTypeService } from 'src/app/services/common/postingType.service';
...
export class PostingTypeComponent implements OnInit,OnChanges {

  errorMessage: string = "required";
  sharedForm: FormGroup;

  entities: PostingType[] = [];
  @Input('value') value: number;
  @Input('required') required: boolean;
  @Input('disabled') disabled: boolean;
  @Output() notify = new EventEmitter();
  constructor(private _fb: FormBuilder, private _service: PostingTypeService) { }
