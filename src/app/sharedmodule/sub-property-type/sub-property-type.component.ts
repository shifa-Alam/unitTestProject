...
import { SubPropertyTypeService } from '../../services/common/subPropertyType.service';

@Component({
  selector: 'app-sub-property-type',
  templateUrl: './sub-property-type.component.html',
  styleUrls: ['./sub-property-type.component.scss']
})
export class SubPropertyTypeComponent implements OnInit, OnChanges{
    ...
    constructor(private _fb: FormBuilder, private _service: SubPropertyTypeService) { }
