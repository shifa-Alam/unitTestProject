...
import { QualificationTypeService } from 'src/app/services/common/qualificationType.service';
import { QualificationType } from 'src/app/models/common/qualificationType';
...
export class QualificationTypeComponent implements OnInit, OnChanges {
  errorMessage: string = "required";
  sharedForm: FormGroup;

  entities: QualificationType[] = [];
  @Input('value') value: number;
  @Input('required') required: boolean;
  @Input('disabled') disabled: boolean;
  @Output() notify = new EventEmitter();
  constructor(private _fb: FormBuilder, private _service: QualificationTypeService) { }
