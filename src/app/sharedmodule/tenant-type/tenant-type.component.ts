...
import { TenantType } from 'src/app/models/common/tenantType';
import { TenantTypeService } from 'src/app/services/common/tenantType.service';

@Component({
  selector: 'app-tenant-type',
  templateUrl: './tenant-type.component.html',
  styleUrls: ['./tenant-type.component.scss']
})
export class TenantTypeComponent implements OnInit, OnChanges {
  ...
  constructor(private _fb: FormBuilder, private _service: TenantTypeService) { }
