...
export class UploadV2Component implements OnInit, OnChanges {
  ...
  @Input('isUploading') isUploading: boolean = false;
  ...
  delete(index: number): void {
    ...
    this.notify.emit({ files: this.files, docTypeId: this.documentTypeId, tags: this.tags, valid: this.files.length > 0 });
  }
