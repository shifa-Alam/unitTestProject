import { LeaveType } from 'src/app/models/common/leaveType';
import { LeaveTypeService } from './../../services/common/leaveType.service';
...
export class LeaveTypeComponent implements OnInit,OnChanges {
  ...
  constructor(private _fb: FormBuilder, private _service: LeaveTypeService) { }
