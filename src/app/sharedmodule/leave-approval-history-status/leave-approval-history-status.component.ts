import { LeaveApprovalHistoryStatusService } from './../../services/common/leaveApprovalHistoryStatus.service';
import { Component, OnInit, Input, Output, EventEmitter, OnChanges, SimpleChange } from '@angular/core';
import { FormGroup, FormBuilder, Validators } from '@angular/forms';
import { LeaveApprovalHistoryStatus } from 'src/app/models/hr/leaveApprovalHistoryStatus';

@Component({
  selector: 'app-leave-approval-history-status',
  templateUrl: './leave-approval-history-status.component.html',
  styleUrls: ['./leave-approval-history-status.component.scss']
})
export class LeaveApprovalHistoryStatusComponent implements OnInit ,OnChanges{

  errorMessage: string = "required";
  sharedForm: FormGroup;

  entities: LeaveApprovalHistoryStatus[] = [];
  @Input('value') value: number;
  @Input('required') required: boolean;
  @Input('disabled') disabled: boolean;
  @Output() notify = new EventEmitter();
  constructor(private _fb: FormBuilder, private _service: LeaveApprovalHistoryStatusService) { }
