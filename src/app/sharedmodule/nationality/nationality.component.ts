...
import { NationalityService } from 'src/app/services/common/nationality.service';
import { Nationality } from 'src/app/models/common/nationality';
...
export class NationalityComponent implements OnInit,OnChanges {
  ...
  constructor(private _fb: FormBuilder, private _service: NationalityService) { }
