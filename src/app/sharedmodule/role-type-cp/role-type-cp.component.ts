...
import { RoleTypeService } from 'src/app/services/common/roleType.service';
import { RoleType } from 'src/app/models/common/roleType';

@Component({
    selector: 'app-role-type-cp',
    templateUrl: './role-type-cp.component.html',
    styleUrls: ['./role-type-cp.component.scss']
})
export class RoleTypeCpComponent implements OnInit, OnChanges {
    ...
    constructor(
        ...
        private _service: RoleTypeService
    ) {
