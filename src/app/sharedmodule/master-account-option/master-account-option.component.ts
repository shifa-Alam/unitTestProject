...
import { MasterAccountOption } from 'src/app/models/common/masterAccountOption';
import { MasterAccountOptionService } from 'src/app/services/common/masterAccountOption.service';

@Component({
  selector: 'app-master-account-option',
  templateUrl: './master-account-option.component.html',
  styleUrls: ['./master-account-option.component.scss']
})
export class MasterAccountOptionComponent implements OnInit {

  errorMessage: string = "required";
  sharedForm: FormGroup;

  entities: MasterAccountOption[] = [];
  @Input('value') value: number;
  @Input('required') required: boolean;
  @Input('disabled') disabled: boolean;
  @Output() notify = new EventEmitter();
  constructor(private _fb: FormBuilder, private _service: MasterAccountOptionService) { }
