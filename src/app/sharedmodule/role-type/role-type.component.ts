...
export class RoleTypeComponent implements OnInit, OnChanges {
    ...
    constructor(private _fb: FormBuilder, private _service: RoleTypeService) {}

    ngOnInit() {
        this.entities = this._service.getJSONAdmin();
